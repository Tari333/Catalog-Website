...
app.get('/pembeli/home', isAuthenticated, checkRole('pembeli'), async (req, res) => {
    try {
        // Render halaman admin dengan data sensor yang telah diproses
        res.render('shared/pembeli_layout', { user: req.session.user, title: 'Pembeli Home', body: 'pembeli/pembeli_home' });
    } catch (error) {
